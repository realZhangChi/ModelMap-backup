...
{
    [DbContext(typeof(ModelMapMigrationsDbContext))]
    [Migration("20210517070123_ChangeRequired")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ModelMap.Diagrams.EntityComponent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<string>("NamespaceBelongingTo")
                        .IsRequired()
                        .HasMaxLength(128)
                    ...
                    b.Property<string>("_baseInterfaces")
                        .HasMaxLength(2048)
                        .HasColumnType("varchar(2048) CHARACTER SET utf8mb4")
                        .HasColumnName("BaseInterfaces");

                    b.Property<string>("_imports")
                        .HasMaxLength(2048)
                        .HasColumnType("varchar(2048) CHARACTER SET utf8mb4")
                    ...
                    b.ToTable("EntityComponents");
                });

            modelBuilder.Entity("ModelMap.Diagrams.PropertyDefine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<Guid>("EntityComponentId")
                        .HasColumnType("char(36)");

                    b.Property<string>("GetAccessLevel")
                        .IsRequired()
                        .HasMaxLength(16)
                        .HasColumnType("varchar(16) CHARACTER SET utf8mb4");
                    ...
                    b.Property<string>("SetAccessLevel")
                        .IsRequired()
                        .HasMaxLength(16)
                        .HasColumnType("varchar(16) CHARACTER SET utf8mb4");
                    ...
                    b.HasIndex("EntityComponentId");

                    b.ToTable("PropertyDefine");
                });

            modelBuilder.Entity("ModelMap.Solutions.Solution", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("ModelMap.Diagrams.EntityComponent", b =>
                {
                    b.OwnsOne("ModelMap.Diagrams.Position", "Position", b1 =>
                        {
                            b1.Property<Guid>("EntityComponentId")
                                .HasColumnType("char(36)");
                            ...
                            b1.HasKey("EntityComponentId");

                            b1.HasIndex("Left");

                            b1.HasIndex("Top");

                            b1.ToTable("EntityComponents");

                            b1.WithOwner()
                                .HasForeignKey("EntityComponentId");
                        });
            ...
            modelBuilder.Entity("ModelMap.Diagrams.PropertyDefine", b =>
                {
                    b.HasOne("ModelMap.Diagrams.EntityComponent", "EntityComponent")
                        .WithMany("Properties")
                        .HasForeignKey("EntityComponentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("EntityComponent");
                });
